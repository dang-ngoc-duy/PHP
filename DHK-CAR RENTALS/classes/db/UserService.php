...
class User {
    ...
    public static function getUserInfo($id) {
        $query = "SELECT first_name, last_name FROM users WHERE _id = :id";
    ...
    public static function getUserDetails($id) {
        $query = "SELECT *, date_format(join_time, '%D %b %Y, %I:%i %p') as join_date  FROM users, address WHERE users._id = :id AND users.address_id = address._id";
    ...
    private static function userExists($id, $method) {
        $query = "SELECT _id FROM users WHERE $method = :$method";
    ...
    public static function verifyUser($id, $password) {
        $query = "SELECT first_name, password FROM users WHERE _id = :id";
    ...
    public static function insertUser($userArray) {
        ...
        $query = 'INSERT INTO users(' . implode(',', $fields) . ') VALUES(:' . implode(',:', $fields) . ')';
